...
const Certs = () => {
  return (
    <section id="certs">
      <img src={edXCert} alt="edXCert" className='self-start w-full max-w-[36rem] rounded-lg'/>
      <div>
        <h1 className='text-white mb-4 text-3xl font-bold'>Certification</h1>
        <ul className='list-disc w-full max-w-[48rem] text-white sm:text-xl'>
